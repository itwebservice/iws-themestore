...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../../../CommonFiles/css/slimmenu.min.css" />
...
<body>
  ...
  <header class="c-header">
    <div class="row align-items-center g-0 menuBar">
      ...
      <div class="col-md-9 col-sm-2 d-sm-none d-none d-md-block nopadding text-right">
        <nav class="menus">
          <ul class="js-customMenuBar slimmenu">
            ...
            <li>
              <a href="#" class="menu-item">Group tour</a>
              <ul>
                <li>
                  <a href="#" class="menu-item">Demo tour</a>
                </li>
                <li><a href="#" class="menu-item">Demo tour</a></li>
              </ul>
            </li>
            <li>
              <a href="#" class="menu-item">Holiday</a>
              <ul>
                <li>
                  <a href="#" class="menu-item">Demo tour</a>
                </li>
            ...
            <li><a href="#" class="menu-item">Hotels</a></li>
            <li><a href="#" class="menu-item">Activities</a></li>
            <li><a href="#" class="menu-item">Visa</a></li>
            <li><a href="#" class="menu-item">Transfer</a></li>
            <li><a href="#" class="menu-item">Cruise</a></li>
            <li>
      ...
      <div class="col-md-1 col-2 nopadding">
        <a href="javascript:void(0)" class="link-button float-right">Offers</a>
      </div>
    </div>
