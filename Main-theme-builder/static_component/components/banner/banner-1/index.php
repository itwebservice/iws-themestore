 ...
 <head>
   ...
   <link rel="stylesheet" href="components/banner/banner-1/css/style.css" />
 </head>
   ...
   <div class="slider">
     ...
     <div class="slider--el slider--el-1 anim-4parts">
       ...
       <div class="slider--el-content">
         <h2 class="slider--el-heading">Himachal Pradesh</h2>
       </div>
     </div>
     <div class="slider--el slider--el-2 anim-9parts">
       ...
       <div class="slider--el-content">
         <h2 class="slider--el-heading">Sindha Lake</h2>
       </div>
     </div>
     <div class="slider--el slider--el-3 anim-5parts">
       ...
       <div class="slider--el-content">
         <h2 class="slider--el-heading">Kashmir Forest</h2>
       </div>
     </div>
     <div class="slider--el slider--el-4 anim-3parts">
       ...
       <div class="slider--el-content">
         <h2 class="slider--el-heading">Manali</h2>
       </div>
     </div>
